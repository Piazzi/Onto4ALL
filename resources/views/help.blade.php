            ...
            <div class="small-box bg-green">
                ...
                <a class="small-box-footer">
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        ...
                        @else
                            <input style="display: block;margin-left: auto;margin-right: auto;" type="image" src="https://www.paypalobjects.com/pt_BR/i/btn/btn_donateCC_LG.gif" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Donate with PayPal button" />
                        @endif    
    ...
    <div class="tab modal fade" id="contactUs"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{route('notifications.send-contact', app()->getLocale())}}">
