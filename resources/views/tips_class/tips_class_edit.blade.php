...
<div class="box box-success">
        ...
        <form  method="post" action="{{route('tips_class.update', $tip_class->id)}}" role="form" ">
            ...
            <div class="form-group">
                <label>Name</label>
                <input required value="{{$tip_class->name}}" name="name" type="text" class="form-control" placeholder="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea required value="{{$tip_class->description}}" name="description" class="form-control" rows="3" placeholder="Enter ...">{{$tip_class->description}}</textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input required value="{{$tip_class->imported_from}}" name="imported_from" type="text" class="form-control"  >
            </div>
            <div class="form-group">
                <label>Example Of Usage</label>
            <input required value="{{$tip_class->example_of_usage}}" name="example_of_usage"  type="text" class="form-control" >
            </div>
