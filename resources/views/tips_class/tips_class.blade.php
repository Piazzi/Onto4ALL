...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <a href="{{route('tips_class.create')}}">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach ($tips_class as $tip_class)
                            <tr>
                                ...
                                <td><a href="{{route('tips_class.show', $tip_class->id)}}">
                                        <button type="button" class="btn btn-block btn-info btn-sm">Info</button>
                                    </a></td>
                                <td><a href="{{route('tips_class.edit', $tip_class->id)}}">
                                        <button type="button" class="btn btn-block btn-warning btn-sm">Edit</button>
                                    </a></td>
                                <td>
                                    <form method="post" action="{{route('tips_class.destroy', $tip_class->id)}}">
                                        @csrf
