...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <a href="{{route('ontology_class.create', app()->getLocale())}}">
                ...
                <div class="box-header">
                    ...
                    <form style="float: right;" method="post" action="{{route('ontology_class.search', ['search' => 'search', 'locale' => app()->getLocale()])}}">
                        @csrf
                        @method('POST')
                        <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach ($classes as $class)
                            <tr>
                                ...
                                <td><a href="{{route('ontology_class.show', ['locale' => app()->getLocale(), 'ontology_class' => $class->id])}}">
                                        <button type="button" class="btn btn-block btn-info btn-sm">Info</button>
                                    </a></td>
                                <td><a href="{{route('ontology_class.edit', ['locale' => app()->getLocale(), 'ontology_class' => $class->id])}}">
                                        <button type="button" class="btn btn-block btn-warning btn-sm">Edit</button>
                                    </a></td>
                                <td>
                                    <form method="post" action="{{route('ontology_class.destroy', ['locale' => app()->getLocale(), 'ontology_class' => $class->id])}}">
                                        @csrf
