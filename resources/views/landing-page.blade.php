    ...
    <body id="page-top">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger"
                                href="#about">{{ __('About') }}</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger"
                                href="#features">{{ __('Features') }}</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger"
                                href="#contact">{{ __('Contact') }}</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger"
                                href="#credits">{{ __('Credits') }}</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger"
                                href="{{ route('login', app()->getLocale()) }}">Login</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger"
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">{{ __('Draw your own ontologies') }}
                        </h1>
                        <hr class="divider light my-4" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">
                            {{ __('Build your first ontology using the many features in our editor') }}</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <a href="{{ route('register', app()->getLocale()) }}"
                            class="btn btn-light btn-xl js-scroll-trigger">{{ __('Start Now') }}</a>
                        <a style="margin-left: 10px" class="btn btn-light btn-xl js-scroll-trigger"
                            href="#features">{{ __('See More') }}</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">
                                {{ __('Save, view, edit your ontologies in our ontology manager and access them later with just one click') }}
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">
                                {{ __('The console will help you build a better ontology by providing to you good modelling practices') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">
                                {{ __('Write correct axioms for classes with the help of this feature') }}</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">
                                {{ __('We aim to make the Onto4ALL a platform for everyone to learn ontology, from begginers to researchers in the area') }}
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">
                                {{ __('Get the information you need about BFO, IAO and IOF ontologies') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid p-0">
                <div class="row no-gutters">
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="css/images/Landing-Page/OurEditor.PNG"><img
                                class="img-fluid" src="css/images/Landing-Page/OurEditor.PNG" alt="" />
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="css/images/Landing-Page/OntologyManager.PNG"><img
                                class="img-fluid" src="css/images/Landing-Page/OntologyManager.PNG" alt="" />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50"></div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="css/images/Landing-Page/OpenWithOneClick.PNG"><img
                                class="img-fluid" src="css/images/Landing-Page/OpenWithOneClick.PNG" alt="" />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50"></div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="css/images/Landing-Page/WarningsConsole.PNG"><img
                                class="img-fluid" src="css/images/Landing-Page/WarningsConsole.PNG" alt="" />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50"></div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="css/images/Landing-Page/TipsMenu.PNG"><img
                                class="img-fluid" src="css/images/Landing-Page/TipsMenu.PNG" alt="" />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50"></div>
                                <div class="project-name">
                                    {{ __('Get the information you need with the tips menu') }}</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="css/images/Landing-Page/MethodologyMenu.PNG"><img
                                class="img-fluid" src="css/images/Landing-Page/MethodologyMenu.PNG" alt="" />
                            <div class="portfolio-box-caption p-3">
                                <div class="project-category text-white-50"></div>
                                <div class="project-name">{{ __('Mark your progress with our methodology menu') }}
                                </div>
                            </div>
                        </a>
                    </div>
        ...
        <section style="background-color: #064c72 !important;" class="page-section bg-dark text-white">
            <div class="container text-center">
                ...
                <div class="row" style="text-align: justify;     text-align-last: center;            ">
                    <div class="col-md-3">
    ...
    <section style="background-color: #064c72 !important;" class="page-section bg-dark text-white">
        <div class="container text-center">
            ...
            <a style="color: black" class="btn btn-light btn-xl"
                href="{{ route('login', app()->getLocale()) }}">{{ __('Register Now!') }}</a>
        </div>
    </section>
        <!-- Contact section -->
        <section class="page-section" id="contact">
