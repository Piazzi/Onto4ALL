    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <label>Name</label>
                <input required value="{{$tips_relation->name}}" name="name" type="text" class="form-control"
                       placeholder="">
            </div>
            <div class="form-group">
                <label>Domain</label>
            ...
            <div class="form-group">
                ...
                <input required value="{{$tips_relation->example_of_usage}}" name="example_of_usage" type="text"
                       class="form-control">
            </div>
            <div class="form-group">
