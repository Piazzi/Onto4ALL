 ...
 */
 ...
 let classObject = mxUtils.createXmlDocument().createElement('object');
 ...
 dataProperties.forEach(element => {classObject.setAttribute( element, '');});


 let relationObject = mxUtils.createXmlDocument().createElement('object');
 ...
 dataProperties.forEach(element => {instanceObject.setAttribute( element, '');});
 ...
 {
	 let fns = [];
	 let paletteName = getTranslation('Taxonomy');

	 classObject.setAttribute('label', getTranslation('Label'));
	 ...
	 relationObject.setAttribute('label', getTranslation('is_a'));
 ...
 */
 ...
 {
	 let fns = [];
	 let paletteName =  getTranslation('Basic Ontology');
	 ...
	 newRelation.setAttribute('label', getTranslation('new_relation'));
 ...
 {
	 let fns = [];
	 let paletteName =  getTranslation('BFO Ontology');

	 // CLASSES
	 let continuant = classObject.cloneNode(true);
	 continuant.setAttribute('label', getTranslation('Continuant'));
	 ...
	 independentContinuant.setAttribute('label', getTranslation('Independent Continuant'));
	 ...
	 genericallyDependentContinuant.setAttribute('label', getTranslation('Generically Dependent Continuant'));
	 ...
	 specificallyDependentContinuant.setAttribute('label', getTranslation('Specifically Dependent Continuant'));
	 ...
	 materialEntity.setAttribute('label', getTranslation('Material Entity'));
	 ...
	 immaterialEntity.setAttribute('label', getTranslation('Immaterial Entity'));
	 ...
	 quality.setAttribute('label', getTranslation('Quality'));
	 ...
	 realizableEntity.setAttribute('label', getTranslation('Realizable Entity'));
	 ...
	 object.setAttribute('label', getTranslation('Object'));
	 ...
	 fiatObjectPart.setAttribute('label', getTranslation('Fiat Object Part'));
	 ...
	 objectAggregate.setAttribute('label', getTranslation('Object Aggregate'));
	 ...
	 site.setAttribute('label', getTranslation('Site'));
	 ...
	 continuantFiatBoundary.setAttribute('label', getTranslation('Continuant Fiat Boundary'));
	 ...
	 spatialRegion.setAttribute('label', getTranslation('Spatial Region'));
	 ...
	 relationalQuality.setAttribute('label', getTranslation('Relational Quality'));
	 ...
	 role.setAttribute('label', getTranslation('Role'));
	 ...
	 disposition.setAttribute('label', getTranslation('Disposition'));
	 ...
	 zeroDimensionalContinuantFiatBoundary.setAttribute('label', getTranslation('Zero-dimensional Continuant Fiat Boundary'));
	 ...
	 oneDimensionalContinuantFiatBoundary.setAttribute('label', getTranslation('One-dimensional Continuant Fiat Boundary'));
	 ...
	 twoDimensionalContinuantFiatBoundary.setAttribute('label', getTranslation('Two-dimensional Continuant Fiat Boundary'));
	 ...
	 zeroDimensionalSpatialRegion.setAttribute('label', getTranslation('Zero-dimensional Spatial Region'));
	 ...
	 oneDimensionalSpatialRegion.setAttribute('label', getTranslation('One-dimensional Spatial Region'));
	 ...
	 twoDimensionalSpatialRegion.setAttribute('label', getTranslation('Two-dimensional Spatial Region'));
	 ...
	 threeDimensionalSpatialRegion.setAttribute('label', getTranslation('Three-dimensional Spatial Region'));
	 ...
	 occurrent.setAttribute('label', getTranslation('Occurrent'));
	 ...
	 process.setAttribute('label', getTranslation('Process'));
	 ...
	 processBoundary.setAttribute('label', getTranslation('Process Boundary'));
	 ...
	 temporalRegion.setAttribute('label', getTranslation('Temporal Region'));
	 ...
	 spatiotemporalRegion.setAttribute('label', getTranslation('Spatiotemporal Region'));
	 ...
	 processProfile.setAttribute('label', getTranslation('Process Profile'));
	 ...
	 zeroDimensionalTemporalRegion.setAttribute('label', getTranslation('Zero-dimensional Temporal Region'));
	 ...
	 oneDimensionalTemporalRegion.setAttribute('label', getTranslation('One-dimensional Temporal Region'));
	 ...
	 instanceOf.setAttribute('label', getTranslation('instance_of'));
	 ...
	 inheresIn.setAttribute('label', getTranslation('inheres_in'));
	 ...
	 bearerOf.setAttribute('label', getTranslation('bearer_of'));
	 ...
	 specificallyDepend.setAttribute('label', getTranslation('specifically_depend'));
	 ...
	 genericallyDepend.setAttribute('label', getTranslation('generically_depend'));
	 ...
	 qualityOf.setAttribute('label', getTranslation('quality_of'));
	 ...
	 participatesIn.setAttribute('label', getTranslation('participates_in'));
	 ...
	 existsAt.setAttribute('label', getTranslation('exists_at'));
	 ...
	 partOf.setAttribute('label', getTranslation('part_of'));
	 ...
	 concretizes.setAttribute('label', getTranslation('concretizes'));
	 ...
	 projectsOnto.setAttribute('label', getTranslation('projects_onto'));
	 ...
	 occupies.setAttribute('label', getTranslation('occupies'));
	 ...
	 locatedIn.setAttribute('label', getTranslation('located_in'));
	 ...
	 occursIn.setAttribute('label', getTranslation('occurs_in'));
	 ...
	 realizes.setAttribute('label', getTranslation('realizes'));
	 ...
	 projectsInto.setAttribute('label', getTranslation('projects_into'));
	 ...
	 roleOf.setAttribute('label', getTranslation('role_of'));
	 ...
	 dispositionOf.setAttribute('label', getTranslation('disposition_of'));
	 ...
	 functionOf.setAttribute('label', getTranslation('function_of'));
