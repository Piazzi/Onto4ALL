...
Sidebar.prototype.init = function()
{
	...
	if(window.location.pathname.split('/')[2] === 'thesaurus-editor')
	{
		...
		//	this.addBasicPalette(dir);   Retirando a paleta basica
...
Sidebar.prototype.addBFOOntologyPalette = function(expand)
{
	...
	if (getLanguage() === 'en')
	{
		fns = [
			// CLASSES
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'continuant', 'continuant', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'independent continuant', 'independent continuant', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'generically dependent continuant', 'generically dependent continuant', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'specifically dependent continuant', 'specifically dependent continuant', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'material entity', 'material entity', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'immaterial entity', 'immaterial entity', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'quality', 'quality', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'realizable entity', 'realizable entity', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'object', 'object', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'fiat object part', 'fiat object part', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'object aggregate', 'object aggregate', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'site', 'site', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'continuant fiat boundary', 'continuant fiat boundary', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'spatial region', 'spatial region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'relational quality', 'relational quality', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'role', 'role', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'disposition', 'disposition', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'zero-dimensional continuant fiat boundary', 'zero-dimensional continuant fiat boundary', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'one-dimensional continuant fiat boundary', 'one-dimensional continuant fiat boundary', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'two-dimensional continuant fiat boundary', 'two-dimensional continuant fiat boundary', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'zero-dimensional spatial region', 'zero-dimensional spatial region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'one-dimensional spatial region', 'one-dimensional spatial region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'two-dimensional spatial region', 'two-dimensional spatial region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'three-dimensional spatial region', 'three-dimensional spatial region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'occurrent', 'occurrent', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'process', 'process', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'process boundary', 'process boundary', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'temporal region', 'temporal region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'spatiotemporal region', 'spatiotemporal region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'process profile', 'process profile', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'zero-dimensional temporal region', 'zero-dimensional temporal region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'one-dimensional temporal region', 'one-dimensional temporal region', null, null, 'circle'),
			// RELATIONS
			...
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'inheres_in', 'inheres_in', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'bearer_of', 'bearer_of', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'specifically_depend', 'specifically_depend', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'generically_depend', 'generically_depend', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'quality_of', 'quality_of', null, 'uml sequence message call invoke dispatch'),
			...
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'exists_at', 'exists_at', null, 'uml sequence message call invoke dispatch'),
			...
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'concretizes', 'concretizes', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'projects_onto', 'projects_onto', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'occupies', 'occupies', null, 'uml sequence message call invoke dispatch'),
			...
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'occurs_in', 'occurs_in', null, 'uml sequence message call invoke dispatch'),
			...
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'projects_into', 'projects_into', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'role_of', 'role_of', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'disposition_of', 'disposition_of', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'function_of', 'function_of', null, 'uml sequence message call invoke dispatch'),
		];
	...
	else
	{
		fns = [
			// CLASSES
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Continuante', 'continuant', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Continuante independente', 'independent continuant', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Continuante genericamente dependente', 'generically dependent continuant', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Continuante especificamente dependente', 'specifically dependent continuant', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Entidade material', 'material entity', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Entidade imaterial', 'immaterial entity', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Qualidade', 'quality', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Entidade realizável', 'realizable entity', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Objeto', 'object', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Parte fiat de objeto', 'fiat object part', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Objeto agregado', 'object aggregate', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Local', 'site', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Limite fiat continuante', 'continuant fiat boundary', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Região espacial', 'spatial region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Qualidade relacional', 'relational quality', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Papel', 'role', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Disposição', 'disposition', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Limite fiat de continuante 0-D', 'zero-dimensional continuant fiat boundary', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Limite fiat de continuante 1-D', 'one-dimensional continuant fiat boundary', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Limite fiat de continuante 2-D', 'two-dimensional continuant fiat boundary', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Região espacial 0-D', 'zero-dimensional spatial region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Região espacial 1-D', 'one-dimensional spatial region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Região espacial 2-D', 'two-dimensional spatial region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Região espacial 3-D', 'three-dimensional spatial region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Ocorrente', 'occurrent', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Processo', 'process', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Limite de processo', 'process boundary', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Região temporal', 'temporal region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Região espaço-temporal', 'spatiotemporal region', null, null, 'circle'),
			this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;Class;', 80, 80, 'Perfil de processo', 'process profile', null, null, 'circle'),
			...
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'g_depende_de', 'generically_depend', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'Qualidade_de', 'quality_of', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'Participa_de', 'participates_in', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'Existe_em', 'exists_at', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'Parte_de', 'part_of', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'Concretiza_em', 'concretizes', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'Projeta_sobre', 'projects_onto', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'Ocupa', 'occupies', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'Localizado_em', 'located_in', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'Ocorre_em', 'occurs_in', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'Realiza', 'realizes', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'q_projeta_em', 'projects_into', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'é_papel_de', 'role_of', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'é_disposição_de', 'disposition_of', null, 'uml sequence message call invoke dispatch'),
			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;Relation;', 80, 0, 'é_função_de', 'function_of', null, 'uml sequence message call invoke dispatch'),
